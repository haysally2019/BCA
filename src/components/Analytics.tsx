...
const Analytics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-academy-blue-600 to-academy-blue-700 rounded-xl p-6 text-white">
        <div className="flex items-center justify-between mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="text-3xl font-bold mb-1">{analyticsData.conversionRate}%</div>
            <div className="text-academy-blue-100 text-sm">Lead Conversion Rate</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold mb-1">${analyticsData.avgDealSize.toLocaleString()}</div>
            <div className="text-academy-blue-100 text-sm">Average Deal Size</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold mb-1">${analyticsData.pipelineValue.toLocaleString()}</div>
            <div className="text-academy-blue-100 text-sm">Pipeline Value</div>
          </div>
        </div>
      </div>
    </div>
